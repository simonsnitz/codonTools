...
#v3.5
#-accepts upper and lower case DNA
#-checks to make sure input is DNA only, asks user to choose to continue or not if other letters present
#-updated language of inputs and outputs

#MODULE 1: INPUT

#This module will allow the user to input the nucleotide sequence which will act as a reference then input the nucleotide sequence to be "shuffle optimized"
#It will take the raw nt sequences, translate them, and align them, thus giving us the tools we need to proceed with the rest of this
...
rawinseq1=input("Please input the reference DNA sequence:\n")
...
rawinseq2=input("Please input the DNA sequence to be optimized:\n")
...
print("Your Optimized Sequence Is:")
print(newstring3)
